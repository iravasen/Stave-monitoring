...
bool staveanalysis(int year, int thisweek){
  ...
  while(infl>>staveid>>hsuid>>hslid>>chipsokHSU>>chipsokHSL>>qualdate>>week){
    ...
    if(staveid=="B-ML-Stave-014" || staveid=="B-ML-Stave-004" || staveid=="B-ML-Stave-006" || staveid=="T-OL-Stave-027" || staveid=="T-OL-Stave-028" || staveid=="T-OL-Stave-023") detgrade=kFALSE;
